...
abstract class CalendarPagerAdapter<V extends CalendarPagerView> extends PagerAdapter {
    ...
    public void setDisabledPastDates(boolean disabledPastDates){
    ...
    public void setRangeDates(CalendarDay min, CalendarDay max) {
        ...
        if (min == null) {
            min = CalendarDay.from(today.getYear() - 10, today.getMonth(), today.getDay());
        }

        if (max == null) {
            max = CalendarDay.from(today.getYear() + 10, today.getMonth(), today.getDay());
        }
